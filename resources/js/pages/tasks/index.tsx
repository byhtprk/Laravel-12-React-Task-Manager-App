...
export default function TasksIndex({ tasks, lists, filters = { search: '', filter: 'all' }, flash }: Props) {
            ...
            <div className="from-background to-muted/20 flex h-full flex-1 flex-col gap-6 rounded-xl bg-gradient-to-br p-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Dialog open={isOpen} onOpenChange={(open) => {
                        ...
                        <DialogContent className="sm:max-w-[425px]" aria-describedby={editingTask ? 'edit-task-form-description' : 'create-task-form-description'}>
                            <DialogHeader>
                                ...
                                <DialogDescription id="task-form-description">
                                    {editingTask ? 'Edit the details of your task below.' : 'Fill in the details to create a new task.'}
                                </DialogDescription>
                            </DialogHeader>
                                    ...
                                    <tr key={task.id} className="hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-colors">
                                        ...
                                        <td className="p-4 align-middle">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {task.list ? task.list.title : 'No list'}
                                            </div>
                                        </td>
                                        <td className="p-4 align-middle">
                                            {task.due_date ? (
